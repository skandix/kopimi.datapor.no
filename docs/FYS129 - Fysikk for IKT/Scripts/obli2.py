...
k = 10000. # N/m. fjærkonstant
m = 930. # kg. masse på bilen
g = -9.81 # m/s^2
dL = -6. # m. lengda på fjæra
rl = 5. # m. radius på loopen
vr = 30. # grader. vinkelen på rampen
lr = 15. # m. lengeden på rampen
vd = 25. # grader. vinkel på dosert sving
rd = 100. # m. radius på dosert sving
...
def vinkelsving(v):
    alpha = math.degrees(math.atan((v)**2/(rd*(-g))))   # for å finne kva vinkel som må 
...
def spring(dL, Ek):
    ...
    xlabel('fjør distanse')
    ylabel('energi')
    figur1.savefig("C:/Users/Paal/UiA/Fys129/Bilder/Spring-energi.png", bbox_inches='tight')
...
def hoppet(V):
    ...
    figur1.savefig("C:/Users/Paal/UiA/Fys129/Bilder/Hopp-lenge.png", bbox_inches='tight')
    figur2.savefig("C:/Users/Paal/UiA/Fys129/Bilder/Hopp-energi.png", bbox_inches='tight')
...
def loopen():
    ...
    figur.savefig("C:/Users/Paal/UiA/Fys129/Bilder/loop-energi.png", bbox_inches='tight')
    figur2.savefig("C:/Users/Paal/UiA/Fys129/Bilder/loop-akselerasjon.png", bbox_inches='tight')
    figur3.savefig("C:/Users/Paal/UiA/Fys129/Bilder/loop-akselerasjon-t.png", bbox_inches='tight')
...
def svingen(v):
    ...
    figur.savefig("C:/Users/Paal/UiA/Fys129/Bilder/sving-energi.png", bbox_inches='tight')
    figur1.savefig("C:/Users/Paal/UiA/Fys129/Bilder/sving-akselerasjon.png", bbox_inches='tight')
